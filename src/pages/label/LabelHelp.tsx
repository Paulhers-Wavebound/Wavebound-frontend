  ...
  return (
    <LabelLayout>
      <div className="p-6 md:p-8 lg:p-10 space-y-6">
        <div>
          <div style={{ fontFamily: '"DM Sans", sans-serif', fontSize: 24, fontWeight: 700, color: 'var(--ink)' }}>
            Help & Support
          </div>
          <div style={{ fontFamily: '"DM Sans", sans-serif', fontSize: 14, color: 'var(--ink-tertiary)', marginTop: 4 }}>
        ...
        <div style={{
          ...
          {FAQ.map((item, i) => (
            ...
            >
              <div style={{ fontFamily: '"DM Sans", sans-serif', fontSize: 14, fontWeight: 600, color: 'var(--ink)', marginBottom: 6 }}>
                {item.q}
              </div>
              <div style={{ fontFamily: '"DM Sans", sans-serif', fontSize: 13, color: 'var(--ink-secondary)', lineHeight: 1.6 }}>
                {item.a}
              </div>
            </div>
          ))}
  ...
  const content = (
    <div style={{
      ...
      <div style={{
        ...
        background: isDisabled ? 'rgba(255,255,255,0.04)' : 'rgba(232,67,10,0.1)',
        display: 'flex', alignItems: 'center', justifyContent: 'center',
      }}>
        <Icon size={20} style={{ color: isDisabled ? 'var(--ink-tertiary)' : '#e8430a' }} />
      </div>
      <div>
        <div style={{ fontFamily: '"DM Sans", sans-serif', fontSize: 15, fontWeight: 600, color: 'var(--ink)', marginBottom: 2 }}>
          {title}
        </div>
      ...
      {action && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 'auto' }}>
          <span style={{ fontFamily: '"DM Sans", sans-serif', fontSize: 13, fontWeight: 600, color: '#e8430a' }}>
            {action}
          </span>
