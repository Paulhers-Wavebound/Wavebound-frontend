...
const FUNCTION_URL = 'https://kxvgbowrkmowuyezoeke.supabase.co/functions/v1/admin-onboarding';
...
export async function callAdminOnboarding(action: string, params: Record<string, unknown> = {}) {
  // Use getUser to force a token refresh if needed, then get fresh session
