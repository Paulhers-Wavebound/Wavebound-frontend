...
import LabelContentPlans from "./pages/label/LabelContentPlans";
                        ...
                        <AISidebarProvider>
                          <ChatSessionsProvider>
                            ...
                            <Routes>
                              ...
                              <Route path="/analyze-audio/:audioId" element={null} />
                              <Route path="/analyze-video/:videoId" element={null} />
                              <Route path="/analyze-favorite/:videoId" element={null} />

                              <Route path="/tiktok-audit/:jobId" element={<TikTokAudit />} />
                              <Route path="/my-analyses" element={<MyAnalyses />} />

                              <Route path="/plan" element={<Navigate to="/content-plan" replace />} />
                              <Route path="/me" element={<MyPage />} />
                              <Route path="/favorites" element={<Favorites />} />

                              <Route path="/my-plans" element={<MyPlans />} />
                              <Route path="/my-plans/:planId" element={<PlanWorkspace />} />
                              <Route path="/share/:shareId" element={<SharedNotes />} />
                              ...
                              <Route path="/chat" element={<ContentAssistant />} />
                              <Route path="/content-plan" element={<ContentPlanPage />} />
                              <Route path="/admin" element={<AdminLayout />}>
                                <Route index element={<Navigate to="/admin/onboarding" replace />} />
                                <Route path="onboarding" element={<AdminOnboarding />} />
                                <Route path="plans" element={<AdminPlanReviewTab />} />
                                <Route path="edit" element={<AdminEditTab />} />
                                <Route path="artists" element={<AdminArtistsTab />} />
                                <Route path="labels" element={<AdminLabelsTab />} />
                              </Route>
                              <Route path="/label" element={<LabelDashboard />} />
                              
                              <Route path="/label/plans" element={<LabelContentPlans />} />
                              <Route path="/label/sound-intelligence" element={<SoundIntelligenceOverview />} />
                              <Route path="/label/sound-intelligence/:jobId" element={<SoundIntelligenceDetail />} />
                              <Route path="/label/amplification" element={<LabelAmplification />} />
                              <Route path="/label/artist/:id" element={<LabelArtistDetailNew />} />
                              <Route path="/label/artists/:artistHandle" element={<LabelArtistProfile />} />
