...
export default function PipelineProgress({ artistHandle, onComplete }: PipelineProgressProps) {
  const [statuses, setStatuses] = useState<Record<string, PhaseStatus> | null>(null);
  ...
  useEffect(() => {
    ...
    const poll = async () => {
      ...
      console.log(`[PipelineProgress] poll for "${artistHandle}":`, { data, error });
                ...
                <TooltipTrigger asChild>
                  <div className="flex flex-col items-center" style={{ width: 22 }}>
                    ...
                    <span
                      ...
                      style={{
                        fontSize: 8,
                        color: status === 'pending' ? 'var(--ink-faint)' : dotColor,
                ...
                <div className="flex items-center" style={{ height: DOT_SIZE }}>
                  <div
                    style={{
                      width: GAP + 2,
                      height: 2,
                      background: status === 'completed' ? 'var(--green)' : 'var(--ink-faint)',
