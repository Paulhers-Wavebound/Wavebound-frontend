...
- Roster table shows Artist, Content Health, Performance, and Activity columns
- Filter tabs: All, Posting Gap, Top Performers, Declining, Format Shift
- Table is sortable by Content Health, Performance, Activity, or Artist name
